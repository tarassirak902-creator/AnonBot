...
async def recheck_required_subscriptions_with_deep_link(
    callback: CallbackQuery,
    state: FSMContext,
) -> None:
    # Imported lazily to avoid a registration-order cycle. This handler is
    # intentionally registered before advertising.py's compatibility handler.
